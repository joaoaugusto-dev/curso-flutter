...
class TodoListPage extends StatefulWidget {
  ...
  const TodoListPage({super.key, required this.isDark, required this.onToggleTheme});
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: ThemeToggleButton(isDark: widget.isDark, onToggle: widget.onToggleTheme),
            ),
          ],
        ),
        body: Center(
